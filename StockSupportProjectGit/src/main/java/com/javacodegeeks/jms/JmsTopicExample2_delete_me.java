...
public class JmsTopicExample2_delete_me implements MessageListener {
	...
	public static void main(String[] args) throws URISyntaxException, Exception {
		JmsTopicExample2_delete_me jmsTopicExample = new JmsTopicExample2_delete_me();
	...
	public void sendReqOnTempTopic() throws URISyntaxException, Exception {
		...
		try {
	        ...
	        try{clientConnection.setClientID("serverTempTopic");}catch ( javax.jms.InvalidClientIDException e) {
